		...
		<body>
                    ...
                    <div class="row justify-content-end">
                        <div class="col-lg-8 col-sm-4 col-8 header-top-right no-padding">
                            <ul>
                                ...
                                <li>
                                        <i> <a href="https://api.whatsapp.com/send?phone=3322695236"> &nbsp; +52 33 22695236 </a> </i>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row align-items-center justify-content-between d-flex">
                    <div id="logo">
                    <a href="/"><img src="img/logo.png" alt="Claty House" title="Logo de Claty House" style="width: 100px; height: 100px;"/></a>
                    </div>
                    ...
                    <ul class="nav-menu">
                        ...
                        <li class="menu-has-children">
                            ...
                            <a href="" id="active"> <?php echo $_SESSION['usuario'];?> </a>
                            <ul>
                    ...
                    <li class="menu-has-children">
                        ...
                        <ul style="overflow: auto; height: 530px; z-index: 999">
                            <li>
							...
							<div class="single-menu">
                                ...
                                <form action="src/add_cart.php" method="post">
                                    ...
                                    <input type="hidden" name="costo" value="<?php echo $pr['Costo'];?>">
                                        <input class="login100-form-btn" type="submit" name="agregar_carrito" value="Agregar al carrito">
                                    </div>
                                </form>
							</div>
						</div>
				...
				<div class="container">
					<div class="row justify-content-start align-items-center">
						<div class="col-lg-6 video-right justify-content-center align-items-center d-flex">
							...
							<a class="play-btn" href="https://youtu.be/JPqr5MqKcG0"><img class="img-fluid" src="img/play-icon.png" alt=""></a>
						</div>
                ...
                <div class="row justify-content-end">
                        <div class="col-lg-8 col-sm-4 col-8 header-top-right no-padding">
                            <ul>
                                ...
                                <li>
                                    <i> <a href="https://www.facebook.com/claty.house">Facebook</a></i>
                                </li>
                                <li>
                                    <i> <a href="https://www.instagram.com/claty.house/">Instagram</a></i>
                                </li>
                            </ul>
                        </div>
                    </div>
